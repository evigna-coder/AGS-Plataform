            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    <th className="px-3 py-2 text-center text-[11px] font-medium text-slate-400 tracking-wider">#</th>
                    <th className="px-3 py-2 text-center text-[11px] font-medium text-slate-400 tracking-wider">Descripcion</th>
                    <th className="px-3 py-2 text-center text-[11px] font-medium text-slate-400 tracking-wider w-24">Cantidad</th>
                    <th className="px-3 py-2 text-center text-[11px] font-medium text-slate-400 tracking-wider w-28">Unidad</th>
