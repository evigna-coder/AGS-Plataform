...
export const CondicionesPago = () => {
  ...
  const sorted = useMemo(() => sortByField(condiciones, sortField, sortDir), [condiciones, sortField, sortDir]);
              ...
              <table className="w-full text-sm">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <SortableHeader label="Descripción" field="descripcion" currentField={sortField} currentDir={sortDir} onSort={handleSort} className="px-3 py-2 text-center text-xs font-medium text-slate-400 tracking-wider" />
