...
import type { PresupuestoItem, CategoriaPresupuesto, ConceptoServicio } from '@ags/shared';
    ...
    return (
      <div className="mt-2 bg-indigo-50 p-3 rounded-lg text-xs">
        ...
        <div className="space-y-0.5 text-slate-600">
          ...
          <p className="font-semibold text-indigo-700 mt-1">Total: {sym} {total.toLocaleString('es-AR', { minimumFractionDigits: 2 })}</p>
        </div>
      </div>
    );
  };
    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      <Card compact className="max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="text-[11px] font-medium text-slate-400 mb-0.5 block">Codigo producto</label>
