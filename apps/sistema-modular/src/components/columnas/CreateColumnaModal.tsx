...
export const CreateColumnaModal: React.FC<Props> = ({ open, onClose, onCreated }) => {
  const navigate = useNavigate();
  const { saveColumna } = useColumnas();
    ...
    <Modal open={open} onClose={handleClose} title="Nueva columna" maxWidth="md">
      <div className="space-y-3">
        ...
        <p className="text-[11px] text-slate-400 italic">
          Los números de serie se cargan desde la pantalla de edición luego de crear la columna.
        </p>
      </div>
