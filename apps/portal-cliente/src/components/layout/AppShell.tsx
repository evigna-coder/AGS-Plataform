...
function AccountChip() {
  ...
  return (
    <button className="flex items-center gap-2.5 rounded-full bg-surface-muted p-1.5 pr-2.5">
      ...
      <span className="hidden text-[13px] font-medium text-ink sm:inline">{cliente.razonSocial}</span>
...
/** Header de escritorio con navegación horizontal. */
...
/** Barra superior compacta para mobile. */
