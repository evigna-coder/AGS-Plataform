      ...
      <div className="flex-1 min-h-0 px-3 md:px-5 pb-4 pt-3">
        ...
        {loading && docs.length === 0 ? (
          ...
          <>
              ...
              {filtered.map(d => (
                <div key={d.id} className="bg-white rounded-xl border border-slate-200 p-3">
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <button onClick={() => setVersionTarget(d)} className="text-[10px] font-medium text-teal-600 hover:text-teal-800 px-1.5 py-0.5 rounded hover:bg-teal-50">Nueva versión</button>
                    <button onClick={() => setHistorialTarget(d)} className="text-[10px] font-medium text-slate-600 hover:text-slate-800 px-1.5 py-0.5 rounded hover:bg-slate-100">Historial</button>
                    <button onClick={() => setEditTarget(d)} className="text-[10px] font-medium text-slate-400 hover:text-slate-600 px-1.5 py-0.5 rounded hover:bg-slate-100 ml-auto">Editar</button>
                  </div>
                </div>
              ))}
            </div>
            ...
            {/* Desktop table */}
            <div className="hidden md:block bg-white rounded-xl border border-slate-200 shadow-sm overflow-y-auto">
                  ...
                  {filtered.map(d => (
                    <tr key={d.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-3 py-2 text-right whitespace-nowrap">
                        <button onClick={() => setVersionTarget(d)} className="text-[10px] font-medium text-teal-600 hover:text-teal-800 px-1.5 py-0.5 rounded hover:bg-teal-50 mr-1">Nueva versión</button>
