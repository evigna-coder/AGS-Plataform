...
export default function QFFilterBar({ search, tipo, familia, mostrarObsoletos, familias, onChange }: Props) {
  return (
    <div className="flex flex-wrap items-center gap-2">
      <input
        ...
        className="flex-1 min-w-[200px] border border-slate-300 rounded-lg px-3 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-teal-500"
      />
      <select
        value={tipo}
        onChange={(e) => onChange.tipo(e.target.value)}
        className="border border-slate-300 rounded-lg px-2 py-1.5 text-xs bg-white focus:outline-none focus:ring-2 focus:ring-teal-500"
      >
