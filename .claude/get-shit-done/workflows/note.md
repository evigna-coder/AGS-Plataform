...
- **Global scope**: `C:/Users/Evigna/Desktop/Ags plataform/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Evigna/Desktop/Ags plataform/.claude/notes/`)
...
2. Glob `C:/Users/Evigna/Desktop/Ags plataform/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Evigna/Desktop/Ags plataform/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Evigna/Desktop/Ags plataform/.claude/notes/` — works in any directory
