...
INSTALL_JS_GLOBAL="C:/Users/Evigna/Desktop/Ags plataform/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Evigna/Desktop/Ags plataform/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
