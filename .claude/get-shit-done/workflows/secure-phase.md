...
```
Agent(
  prompt="Read C:/Users/Evigna/Desktop/Ags plataform/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Evigna/Desktop/Ags plataform/.claude/get-shit-done/templates/SECURITY.md`
