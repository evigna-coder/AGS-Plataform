...
@C:/Users/Evigna/Desktop/Ags plataform/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/Users/Evigna/Desktop/Ags plataform/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
